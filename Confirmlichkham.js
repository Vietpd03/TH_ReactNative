...
class Confirmlichkham extends Component {
  constructor(props) {
    super(props);
    this.state = {
      appointments: [
  ...
  renderItem = ({ item }) => (
    <View style={styles.itemContainer}>
      ...
      <TouchableOpacity style={styles.button} onPress={() => this.props.navigation.navigate('Ratoathuoc')}>
        <Text style={styles.buttonText}>Xác Nhận lịch khám </Text>
      </TouchableOpacity>
    </View>
  );
    ...
    return (
      <View style={styles.container}>
        <View style={styles.headerContainer}>
          ...
          <Text style={styles.username}>Tên y tá</Text>
...
export default Confirmlichkham;
